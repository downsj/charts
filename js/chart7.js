var Chart = new Class({
  ...
  fMargins: {top: 10, bottom: 25, left: 45, right: 30},
  cMargins: {top: 25, bottom: 20},
  ...
  /**
  * @author Jacob Downs
  * @description Initializes a chart element in the given selection and returns a chart object for interacting
  * with the chart element
  * @param selection A container for the chart (usually a div)
  * @param config A configuration object for specifying chart paramaters 
  */
  initialize: function(selection, config) {
    ...
    // Add the svg element and append the containers
    ...
    svg.append("text")
    .attr("class", "ya-label")
    .attr("transform", "translate(" + 10 + "," + (yShift + this.fHeight/2) + "),rotate(-90)")
    .text(this.yaLabel);

    // Add a x axis label
    svg.append("text")
    .attr("class", "xa-label")
    .attr("transform", "translate(" + (this.fMargins.left + this.fWidth/2) + "," + (yShift + this.fHeight + 35) + ")")
    .text(this.xaLabel);
  ...
  /**
  * @author Jacob Downs
  * @description Adds a scroll bar to the chart
  */
  initScroll: function() {
  ...
  /**
  * @author Jacob Downs
  * @description Adds the context view to the chart
  */
  ...
  /**
  * @author Jacob Downs
  * @description Updates the context data based on the position and size of the scroll bar and 
  ...
  */
  ...
  /**
  * @author Jacob Downs
  * @description Adds the focus view to the chart
  */
  initFocus: function() {
  ...
  /**
  * @author Jacob Downs
  * @description Updates the line graph in the focus view when the scroll bar moves or when the brush in 
  * in the focus view is moved or resized
  * @param animate dataType boolean Flag that specifies whether or not to animate the focus. This will be 
  * set to true only when adding a new data point.
  */
  ...
  /**
  * @author Jacob Downs
  * @description Updates the data to be displayed in the focus when the scroll bar moves or the brush in the context 
  * view is moved or resized
  * @param animate dataType boolean Flag that specifies whether or not the focus will be animated after the focus data 
  * is updated. This affects how the method gets its data. 
  */
  ...
  /**
  * @author Jacob Downs
  * @description Event fired when the scroll bar moves
  * @param d dataType Object Contains the current x,y coordinates of the scroll bar
  */
  ...
  /**
  * @author Jacob Downs
  * @description Computes the width of the scroll bar based on the number of points to be 
  ...
  */
  ...
  /**
  * @author Jacob Downs
  * @description Updates the context data points based on the width and position of the scroll bar
  */
  ...
  /**
  * @author Jacob Downs
  * @description Initializes all of the scales used for drawing the graph
  */
  initScales: function() {
  ...
  /**
  * @author Jacob Downs
  * @description Convenience function for updating the sSD scale 
  */
  setSSD: function() {
    this.sSD
      .domain([0, this.fWidth])
  ...
  /**
  * @author Jacob Downs
  * @description Function called when the brush is moved or resized
  */
  onBrush: function() {
    this.updateFocus();
  },
  ...
  /**
  * @author Jacob Downs
  * @description Adds a new data point into the data array and then automatically updataes the chart
  * @param point dataType Object A timestamp value pair representing one data point on the graph
  */
  ...
  /**
  * @author Jacob Downs
  * @description Wrapper function around addDataPoint that adds a random point to the graph
  */
  ...
  /**
  * @author Jacob Downs
  * @description Wrapper function around addDataPoint that adds the value n to the graph
  * @param n dataType number The value of the data point 
  */
  addPoint: function(n) {
    var t = this.data[this.data.length - 1].ts;
  ...
  /**
  * @author Jacob Downs
  * @description Function fired when the mouse moves inside of the the focus view
  * @param rect Object An invisible rectangle placed over the focus view that is used to determine 
  * the coordinates of the mouse within the focus view
  */
  ...
  /**
  * @author Jacob Downs
  * @description Function called when the add point animation starts
  */
  ...
  /**
  * @author Jacob Downs
  * @description Function called immediately after the add point animation ends
  */
  ...
  /**
  * @author Jacob Downs
  * @description Returns the greates value in the data array
  */
  getMaxVal : function(){
    var max = 0;
